...
public class UserMoreMenuActivity extends BaseMenuActivity implements View.OnClickListener {
    ...
    private void saveAsContact() {
        ...
        values.put(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME, (mUser.nickname + mUser.name));
        ...
        values.put(ContactsContract.CommonDataKinds.Email.DATA, mUser.email);
        ...
        values.put(ContactsContract.CommonDataKinds.Phone.NUMBER, mUser.phone);
